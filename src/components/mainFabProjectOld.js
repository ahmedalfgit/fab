...
class FabProject extends Component {
  state = {
    //video url links
    videos: ["https://player.vimeo.com/video/331323695", "https://player.vimeo.com/video/382234067", "https://player.vimeo.com/video/380594758", "https://player.vimeo.com/video/380576380", "https://player.vimeo.com/video/389857569"],

    //video names
    videoNames : ["Design", "Laser Cutting", "Bending", "Machining", "Welding"],

    //video bullet points attached to videos
    videoBulletPoints: [ "SolidWorks, AutoCAD, Illustrator, and Fusion 360", "Cut up to a 6’ x 12’ sheet of material | ½” thick mild steel, stainless steel , or aluminum", " ½” thick and up to 14 feet long | 40-ton GOFORM Press Brake", " 2' x 25' workable area | drilling, milling, and tapping.", "Stick, MIG, TIG, and Robotic welding"],

    //list icons 
    photos: [designIcon, laserIcon, metalFormingIcon, machiningIcon, weldingIcon],
    active: 0,
  ...
  render() {
    const {videos, videoNames, videoBulletPoints, photos, active, emailForm, selectedOption, isBoxVisible} = this.state;  
        ...
        <div className="project-col col-md-7 mt-md-3">
          <div className="row project-icons-row pt-md-5 mt-md-5">
            <div className="col-md-12 project-header-col">
              <h1 className="text-left font-weight-bold">Start Your Project</h1>
            </div>
            <div className={`col-12 project-list-col ${isBoxVisible ? "" : "show"}`}>
          ...
          <div className="row project-details text-center p-5 m-4">
             <div className="col-12">
               <form id="fabForm" onSubmit={this.handleEmailQuery} className={`fab-form ${isBoxVisible ? "" : "show"}`}>
                      <input type="text" value={this.state.emailForm.name} onChange={this.handleFormName.bind(this)} placeholder="Name" className="w-100 p-2 project-input" project-input/>

                      <input type="email" value={this.state.emailForm.email} onChange={this.handleFormEmail} placeholder="Email" className="w-100 p-2 project-input"/>

                      <input type="tel" value={this.state.emailForm.phone} onChange={this.handleFormPhone} placeholder="Phone" className="w-100 p-2 project-input" project-input/>

                      <textarea type="text" value={this.state.emailForm.summary} onChange={this.handleFormSummary} placeholder="Project details" className="w-100 p-2 project-input text-area" project-input/>
                      <Select
                          isMulti={true}
                      ...
                      <input type="submit" value={"Send"} className="btn btn-primary w-50 p-2 mt-4"/>
               </form>
               <div className="row justify-content-center pt-5" className={`row justify-content-center pt-5 project-details-row ${isBoxVisible ? "" : "show"}`}>
                 <div className="col-12">
                   <button className="btn btn-primary w-50 p-2" onClick={this.toggleForm.bind(this)}>Project details</button>
                 </div>
               </div>
             </div>
          </div>
